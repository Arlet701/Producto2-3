...
{
    public partial class AgregarIncapacidad : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            op.AgregarIncap(Periodo, Comprobacion, Extra, F_positivoProfe);
            Response.Write("<script>alert('Tipo de incapacidad registrado exitosamente');</script>");
        }
    }
}