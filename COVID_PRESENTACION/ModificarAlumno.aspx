...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>Escribe únicamente la matrícula a actualizar*</p>
    <div class="container">
        ...
        <div class="form-group">
             ...
             <asp:TextBox ID="TextBox7" CssClass="form-control" runat="server"></asp:TextBox>
                  <br />
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox7" ErrorMessage="*Debe ingresar números" ForeColor="#F40000" ValidationExpression="[0-9]*"></asp:RegularExpressionValidator>
                  <br />
             <br />
        </div>
        <div class="form-group">
