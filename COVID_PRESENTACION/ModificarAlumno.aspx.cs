...
namespace COVID_PRESENTACION
{
    public partial class ModificarAlumno : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            op.ModificarAl(Matricula, Nombre, Ap_pat, Ap_mat, Genero, Correo, Celular, F_EdoCivil);
            Response.Write("<script>alert('Información de alumno actualizado exitosamente');</script>");
        }
    }
}