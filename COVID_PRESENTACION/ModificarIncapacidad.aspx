...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="form-group">
            Ingrese el periodo para actualizar*<br />
            <asp:Label ID="Label1" runat="server" Text="Periodo (N° +días): "></asp:Label>
            ...
            <br />
        <div class="form-group">
            <asp:Label ID="Label3" runat="server" Text="Extra(opcional): "></asp:Label>
