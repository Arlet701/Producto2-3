...
namespace COVID_PRESENTACION
{
    public partial class ModificarProfesor : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            op.ModificarProf(Reg, Nombre, Ap_pat, Ap_Mat, Genero, Categoria, Correo, Celular, F_EdoCivil);
            Response.Write("<script>alert('Información de profesor actualizado exitosamente');</script>");
        }
    }
}